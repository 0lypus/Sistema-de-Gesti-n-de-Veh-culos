...
• Desde el programa principal se deben ejecutar acciones sobre distintos vehículos y mostrar los resultados en consola.
El programa debe demostrar: • Uso de herencia.
• Polimorfismo.
